...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<MovieDetailsBloc>(
      create: (context) => sl<MovieDetailsBloc>()..add(GetMovieDetailsEvent(movieId: id))..add(GetMovieRecommendationEvent(movieId: id)),
      lazy: false,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8.0),
                      Text(
                        '${StringConstance.genres}: ${_showGenres(state.movieDetails!.genre)}',
                        style: const TextStyle(
                          color: Colors.white70,
                          fontSize: 12.0,
                          fontWeight: FontWeight.w500,
